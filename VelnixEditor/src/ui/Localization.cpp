...
const std::vector<TranslationRow> kTranslations{
    ...
    {"menu.highlight", "Highlight", "強調表示", "강조", "Resaltar", "Realçar", "Hervorheben", "Surligner", "تمييز", "醒目提示", "高亮", "醒目提示"},
    {"menu.highlight_yellow", "Yellow", "黄色", "노랑", "Amarillo", "Amarelo", "Gelb", "Jaune", "أصفر", "黃色", "黄色", "黃色"},
    {"menu.highlight_green", "Green", "緑", "초록", "Verde", "Verde", "Grün", "Vert", "أخضر", "綠色", "绿色", "綠色"},
    {"menu.highlight_blue", "Blue", "青", "파랑", "Azul", "Azul", "Blau", "Bleu", "أزرق", "藍色", "蓝色", "藍色"},
    {"menu.highlight_pink", "Pink", "ピンク", "분홍", "Rosa", "Rosa", "Pink", "Rose", "وردي", "粉紅", "粉色", "粉紅"},
    {"menu.highlight_orange", "Orange", "オレンジ", "주황", "Naranja", "Laranja", "Orange", "Orange", "برتقالي", "橙色", "橙色", "橙色"},
    {"menu.highlight_purple", "Purple", "紫", "보라", "Morado", "Roxo", "Violett", "Violet", "بنفسجي", "紫色", "紫色", "紫色"},
    {"menu.clear_custom_highlights", "Cancel Custom Syntax Highlighting", "カスタム構文強調を解除", "사용자 지정 구문 강조 취소", "Cancelar resaltado de sintaxis personalizado", "Cancelar realce de sintaxe personalizado", "Benutzerdefinierte Syntaxhervorhebung aufheben", "Annuler la coloration syntaxique personnalisee", "إلغاء تمييز الصياغة المخصص", "取消自訂語法醒目提示", "取消自定义语法高亮", "取消自訂語法醒目提示"},
    {"menu.clear_highlights", "Clear All Highlights", "すべての強調表示を解除", "모든 강조 지우기", "Borrar todos los resaltados", "Limpar todos os realces", "Alle Hervorhebungen löschen", "Effacer tous les surlignages", "مسح كل التمييز", "清除全部醒目提示", "清除全部高亮", "清除全部醒目提示"},
    ...
    {"menu.help", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?"},
    {"menu.check_updates", "Check for Updates", "更新を確認", "업데이트 확인", "Buscar actualizaciones", "Procurar atualizações", "Nach Updates suchen", "Rechercher des mises à jour", "التحقق من وجود تحديثات", "檢查更新", "检查更新", "檢查更新"},
    ...
    {"update.checking", "Checking for updates...", "更新を確認しています...", "업데이트 확인 중...", "Buscando actualizaciones...", "Procurando atualizações...", "Updates werden gesucht...", "Recherche de mises à jour...", "جار التحقق من التحديثات...", "正在檢查更新...", "正在检查更新...", "正在檢查更新..."},
    {"update.available", "Velnix Editor %s is available.", "Velnix Editor %s が利用可能です。", "Velnix Editor %s을 사용할 수 있습니다.", "Velnix Editor %s está disponible.", "Velnix Editor %s está disponível.", "Velnix Editor %s ist verfügbar.", "Velnix Editor %s est disponible.", "يتوفر Velnix Editor %s.", "Velnix Editor %s 已推出。", "Velnix Editor %s 已发布。", "Velnix Editor %s 已推出。"},
    {"update.available_detail", "You are using version %s. Open the homepage to get the new package.", "現在のバージョンは %s です。ホームページから新しいパッケージを入手できます。", "현재 버전은 %s입니다. 홈페이지에서 새 패키지를 받을 수 있습니다.", "Está usando la versión %s. Abra la página de inicio para obtener el nuevo paquete.", "Você está usando a versão %s. Abra a página inicial para obter o novo pacote.", "Sie verwenden Version %s. Öffnen Sie die Homepage, um das neue Paket zu erhalten.", "Vous utilisez la version %s. Ouvrez la page d'accueil pour obtenir le nouveau paquet.", "أنت تستخدم الإصدار %s. افتح الصفحة الرئيسية للحصول على الحزمة الجديدة.", "目前使用版本 %s。開啟主頁取得新版軟體包。", "当前使用版本 %s。打开主页获取新版软件包。", "目前使用版本 %s。開啟首頁取得新版軟體套件。"},
    {"update.up_to_date", "Velnix Editor is up to date.", "Velnix Editor は最新です。", "Velnix Editor가 최신 버전입니다.", "Velnix Editor está actualizado.", "Velnix Editor está atualizado.", "Velnix Editor ist aktuell.", "Velnix Editor est à jour.", "Velnix Editor محدث.", "Velnix Editor 已是最新版本。", "Velnix Editor 已是最新版本。", "Velnix Editor 已是最新版本。"},
    {"update.up_to_date_detail", "You are using the latest version, %s.", "最新バージョン %s を使用しています。", "최신 버전 %s을 사용하고 있습니다.", "Está usando la versión más reciente, %s.", "Você está usando a versão mais recente, %s.", "Sie verwenden die aktuelle Version %s.", "Vous utilisez la dernière version, %s.", "أنت تستخدم أحدث إصدار، %s.", "目前使用最新版本 %s。", "当前使用最新版本 %s。", "目前使用最新版本 %s。"},
    {"update.failed", "Unable to check for updates.", "更新を確認できませんでした。", "업데이트를 확인할 수 없습니다.", "No se pudo buscar actualizaciones.", "Não foi possível procurar atualizações.", "Die Updateprüfung ist fehlgeschlagen.", "Impossible de rechercher des mises à jour.", "تعذر التحقق من وجود تحديثات.", "無法檢查更新。", "无法检查更新。", "無法檢查更新。"},
    {"update.open_homepage", "Open Homepage", "ホームページを開く", "홈페이지 열기", "Abrir página de inicio", "Abrir página inicial", "Homepage öffnen", "Ouvrir la page d'accueil", "فتح الصفحة الرئيسية", "開啟主頁", "打开主页", "開啟首頁"},
    {"update.later", "Later", "後で", "나중에", "Más tarde", "Mais tarde", "Später", "Plus tard", "لاحقًا", "稍後", "稍后", "稍後"},
